		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
						<a class="nav-link bi bi-bag" href="ProductoS?menu=listarAdmin"  target="myFrame"> Productos</a> 
						<a class="nav-link bi bi-person-fill-add" href="EmpleadoS?menu=listar" target="myFrame"> Empleados</a> 					
