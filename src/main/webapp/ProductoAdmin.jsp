				...
				<form action="ProductoS" method="post" enctype="multipart/form-data" name="formProducto">
					...
					<div class="form-group">		
						<label>Codigo</label> <input class="form-control" type="text"
							...
							pattern= "[0-9]+" maxlength="5" title="Por favor, ingrese solo números, maximo 5 caracteres(sin guiones ni espacios)" required/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Precio</label> <input class="form-control" type="text"
							...
							pattern="[0-9]+(\.[0-9]+)?" step="any" title="Por favor, ingrese solo números decimales (p. ej. 10 o 10.5)"  maxlength="6" required/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Cantidad</label> <input class="form-control" type="text"
							...
							pattern= "[0-9]+" maxlength="3" title="Por favor, ingrese solo números, maximo 3 caracteres(sin guiones ni espacios)" required/>
					</div>
					<div class="form-group">
				    <label></label><br>
				    <div>
